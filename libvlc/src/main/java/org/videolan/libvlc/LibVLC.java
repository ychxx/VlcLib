    ...
    static synchronized void loadLibraries() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD_MR1
            ...
            try {
                ...
                VlcLog.d(TAG, "anw library not loaded");
            }
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1)
                    VlcLog.w(TAG, "Unable to load the iomx library: " + t);
            }
        }
        ...
        try {
            ...
            VlcLog.w(TAG, "Can't load vlcjni library: " + ule);
            /// FIXME Alert user
            System.exit(1);
        } catch (SecurityException se) {
            VlcLog.w(TAG, "Encountered a security issue when loading vlcjni library: " + se);
            /// FIXME Alert user
            System.exit(1);
        }
    }
